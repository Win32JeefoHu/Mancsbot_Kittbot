 ...
 return <div className="stack">
  <div className="hud-card intro-panel">
   ...
   <div className="metrics">
    ...
    <Metric label="Min. setup score" value={structure.scoreThreshold==null?'—':String(structure.scoreThreshold)+'/100'}/>
    <Metric label="History bootstrap" value={structure.bootstrapCompleted?'READY':'BUILDING'}/><Metric label="Threshold optimizer" value={opt.running?'RUNNING':(lastOpt.status||'READY')}/>
   </div>
  </div>
